class BedsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @bed.save
        format.html { redirect_to backend_path, notice: 'Bed was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @bed.update(bed_params)
        format.html { redirect_to backend_path, notice: 'Bed was successfully updated.' }
  ...
  def destroy
    @bed.destroy
    respond_to do |format|
      format.html { redirect_to backend_path, notice: 'Bed was successfully destroyed.' }
