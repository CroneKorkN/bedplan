...
class FullfillmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fullfillment" do
    assert_difference('Fullfillment.count') do
      post fullfillments_url, params: { fullfillment: { bed_id: @fullfillment.bed_id, day: @fullfillment.day, employee_id: @fullfillment.employee_id, month_id: @fullfillment.month_id } }
    end
  ...
  test "should update fullfillment" do
    patch fullfillment_url(@fullfillment), params: { fullfillment: { bed_id: @fullfillment.bed_id, day: @fullfillment.day, employee_id: @fullfillment.employee_id, month_id: @fullfillment.month_id } }
