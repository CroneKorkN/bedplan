...
class MonthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create month" do
    assert_difference('Month.count') do
      post months_url, params: { month: { date: @month.date, employee_count: @month.employee_count } }
    end
  ...
  test "should update month" do
    patch month_url(@month), params: { month: { date: @month.date, employee_count: @month.employee_count } }
